    ...
    child: Column(
      ...
      children: [
        FSelectGroup(
          ...
          children: [
            .checkbox(value: Language.dart, label: const Text('Dart')),
            .checkbox(value: Language.java, label: const Text('Java')),
            .checkbox(value: Language.rust, label: const Text('Rust')),
            .checkbox(value: Language.python, label: const Text('Python')),
          ],
        ),
    ...
    child: Column(
      ...
      children: [
        FSelectGroup(
          ...
          children: [
            .radio(value: Notification.all, label: const Text('All new messages')),
            .radio(value: Notification.direct, label: const Text('Direct messages and mentions')),
            .radio(value: Notification.nothing, label: const Text('Nothing')),
          ],
        ),
        const SizedBox(height: 20),
        FButton(
