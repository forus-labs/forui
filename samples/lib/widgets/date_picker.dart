...
class DatePickerPage extends Sample {
  DatePickerPage({@queryParam super.theme, super.alignment = Alignment.topCenter});

  @override
  Widget sample(BuildContext context) => const Padding(
    padding: EdgeInsets.only(top: 30),
    child: FDatePicker(label: Text('Appointment Date'), description: Text('Select a date for your appointment')),
  );
}

@RoutePage()
class CalendarDatePickerPage extends Sample {
  CalendarDatePickerPage({@queryParam super.theme, super.alignment = Alignment.topCenter});
...
class InputDatePickerPage extends Sample {
  InputDatePickerPage({@queryParam super.theme});
...
class ValidatorDatePickerPage extends StatefulSample {
  ValidatorDatePickerPage({@queryParam super.theme, super.alignment = Alignment.topCenter});
...
class FormDatePickerPage extends StatefulSample {
  FormDatePickerPage({@queryParam super.theme, super.alignment = Alignment.topCenter});
...
class _FormDatePickerPageState extends StatefulSampleState<FormDatePickerPage> with TickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _startDateController = FDatePickerController(vsync: this, validator: _validateStartDate);
    _endDateController = FDatePickerController(vsync: this, validator: _validateEndDate);
  }
