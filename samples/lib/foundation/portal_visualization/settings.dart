          ...
          children: [
            Expanded(
              child: FTextField(
                control: .managed(
                  onChange: (v) =>
                      value.portalSize = Size(double.tryParse(v.text) ?? value.portalSize.width, value.portalSize.height),
            ...
            Expanded(
              child: FTextField(
                control: .managed(
                  onChange: (v) =>
                      value.portalSize = Size(value.portalSize.width, double.tryParse(v.text) ?? value.portalSize.height),
