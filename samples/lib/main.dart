...
class _AppRouter extends RootStackRouter {
  ...
  List<AutoRoute> get routes => [
        ...
        AutoRoute(path: '/select-tile/default', page: SelectTileRoute.page),
        AutoRoute(path: '/select-tile/subtitle', page: SelectTileSubtitleRoute.page),
        AutoRoute(path: '/select-tile/details', page: SelectTileDetailsRoute.page),
        AutoRoute(path: '/select-tile/suffix', page: SelectTileSuffixRoute.page),
