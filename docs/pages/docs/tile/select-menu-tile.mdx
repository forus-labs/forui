  ...
  <Tabs.Tab>
    ...
    class _SelectMenuTileState extends State<_SelectMenuTile> {
      ...
      Widget build(BuildContext context) => FSelectMenuTile(
        ...
        popover: const FSelectMenuTileMenuProperties(autoHide: true),
...
FSelectMenuTile<Value>(
  ...
  popover: FSelectMenuTilePopoverProperties(...),
  menu: FSelectMenuTileMenuProperties(...),
      ...
      Widget build(BuildContext context) => Form(
            ...
            child: Column(
              ...
              children: [
                FSelectMenuTile(
                  controller: controller,
                  popover: FSelectMenuTilePopoverProperties(autoHide: true),
