...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    class _SelectMenuTileState extends State<_SelectMenuTile> {
      final controller = FSelectController.radio(value: Notification.all);
...
FSelectMenuTile<Value>(
  selectController: FSelectController(), // or FSelectController.radio()
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    class _SelectMenuTileState extends State<_SelectMenuTile> {
      final controller = FSelectController.radio(Notification.all);
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    class _SelectMenuTileFormState extends State<_SelectMenuTileForm> {
      ...
      final controller = FSelectController.radio();
