...
FSelectTileGroup<Value>(
  groupController: FSelectController(), // or FSelectController.radio()
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```dart {5} copy
    FSelectTileGroup(
      selectController: FSelectController(values: {Sidebar.recents}),
      label: const Text('Settings'),
      description: const Text('Personalize your experience'),
      maxHeight: 100,
      children: [
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    FSelectTileGroup.builder(
      selectController: FSelectController(values: {1}),
      label: const Text('Settings'),
      description: const Text('Personalize your experience'),
      maxHeight: 200,
      count: 200,
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```dart {4, 9} copy
    FSelectTileGroup(
      selectController: FSelectController.radio(),
      label: const Text('Settings'),
      children: [
        FSelectTile.suffix(
