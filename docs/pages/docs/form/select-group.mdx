...
<LinkBadgeGroup>
    <LinkBadge label="API Reference" href="https://pub.dev/documentation/forui/latest/forui.widgets.select-group/forui.widgets.select-group-library.html"/>
</LinkBadgeGroup>

<Callout type="info">
    For touch devices, a [FSelectTileGroup](/docs/tile/select-tile-group) is generally recommended over a [FSelectGroup](/docs/form/select-group).
</Callout>
