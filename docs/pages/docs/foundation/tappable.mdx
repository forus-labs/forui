...
A varient of `FTappable` without any animation. This is similar to using `FTappableAnimation.none`.
...
```dart copy
// Default animation.
FTappableStyle(animationTween: FTappableAnimation.bounce);

// No animation.
FTappableStyle(animationTween: FTappableAnimation.none);
