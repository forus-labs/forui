...
[`FTheme`](https://pub.dev/documentation/forui/latest/forui.theme/FTheme-class.html) widget near the root of the widget
tree, beneath a
[`CupertinoApp`](https://api.flutter.dev/flutter/cupertino/CupertinoApp-class.html),
[`MaterialApp`](https://api.flutter.dev/flutter/material/MaterialApp-class.html), or
[`WidgetsApp`](https://api.flutter.dev/flutter/widgets/WidgetsApp-class.html).

It's perfectly safe to use Forui widgets alongside Material/Cupertino widgets. This is especially useful when you need
to use a Material/Cupertino widget that is not available in Forui or require it for routing.

```dart filename="main.dart" {3,15-18}
...
class Application extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) => MaterialApp( // Replace MaterialApp with WidgetsApp/CupertinoApp respectively.
