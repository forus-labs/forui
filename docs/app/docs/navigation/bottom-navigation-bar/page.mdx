...
<LinkBadgeGroup>
  <LinkBadge
    label="API Reference"
    href="https://pub.dev/documentation/forui/latest/forui.widgets.bottom_navigation_bar/"
  />
</LinkBadgeGroup>
...
<Callout type="info">
  A bottom navigation bar is typically used with `FScaffold`. A working example can be found
  [here](/docs/layout/scaffold).
</Callout>
