...
An optional widget that can be used to group several `FSidebarItem`s.
...
<Tabs items={['Preview', 'Code']}>
    <Tabs.Tab>
        <Widget name='sidebar' variant='custom-width' height={250} />
    </Tabs.Tab>
    <Tabs.Tab>
        ```dart {2} copy
        FSidebar(
...
<Tabs items={['Preview', 'Code']}>
    <Tabs.Tab>
        <Widget name='sidebar' variant='nested' height={450} />
    </Tabs.Tab>
    <Tabs.Tab>
        ```dart copy
        FSidebar(
