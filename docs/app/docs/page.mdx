...
From `0.17.0` onwards, Forui provide [data driven fixes](https://github.com/flutter/flutter/blob/master/docs/contributing/Data-driven-Fixes.md).
This means that you automate some of the migration by running `dart fix --apply`.
