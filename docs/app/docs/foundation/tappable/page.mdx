...
```dart copy
// Default animation.
FTappableStyle(bounceTween: FTappableStyle.defaultBounceTween);

// No animation.
FTappableStyle(bounceTween: FTappableStyle.noBounceTween);

// Custom tween.
FTappableStyle(bounceTween: Tween(begin: 1.0, end: 0.97));
```
