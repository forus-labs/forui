...
<Callout type="info">
  The best way to find a list of icons is to visit the [Lucide](https://lucide.dev/icons/) website. We update the icons
  in the Forui Assets package with each Forui release. If you notice a missing icon in Forui Assets, please [open an
  issue](https://github.com/forus-labs/forui/issues/new).
</Callout>
