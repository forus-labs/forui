...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```dart copy FAlert( title: const Text('Heads Up!'), subtitle: const Text('You can add components to your app using
    the cli.'), ); ```
  </Tabs.Tab>
</Tabs>
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```dart {4} copy FAlert( title: const Text('Heads Up!'), subtitle: const Text('You can add components to your app
    using the cli.'), style: FAlertStyle.destructive, ); ```
  </Tabs.Tab>
</Tabs>
