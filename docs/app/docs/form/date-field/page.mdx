...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```dart copy const FDateField( label: Text('Appointment Date'), description: Text('Select a date for your
    appointment'), ); ```
  </Tabs.Tab>
</Tabs>
...
FDateField.calendar(
  ...
  today: DateTime.now(),
  initialType: FCalendarFieldType.yearMonth,
  autoHide: true,
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```dart copy const FDateField.calendar( label: Text('Appointment Date'), description: Text('Select a date for your
    appointment'), ); ```
  </Tabs.Tab>
</Tabs>
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```dart copy FDateField.input( label: Text('Appointment Date'), description: Text('Select a date for your
    appointment'), ); ```
  </Tabs.Tab>
</Tabs>
