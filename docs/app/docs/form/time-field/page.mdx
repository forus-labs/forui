...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```dart copy const FTimeField( label: Text('Appointment Time'), description: Text('Select a time for your
    appointment.'), ); ```
  </Tabs.Tab>
</Tabs>
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```dart {2} copy const FTimeField( hour24: true, label: Text('Appointment Time'), description: Text('Select a time
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ```dart copy const FTimeField.picker( label: Text('Appointment Time'), description: Text('Select a time for your
    appointment.'), ); ```
  </Tabs.Tab>
</Tabs>
...
<Tabs items={['Preview', 'Code']}>
    ...
    <Tabs.Tab>
        ...
        class _ValidationTimeFieldPageState extends State<ValidatorTimeFieldPage> with SingleTickerProviderStateMixin {
          ...
          String? _validate(FTime? time) => time == 12 ? 'Time cannot be noon.' : null;
