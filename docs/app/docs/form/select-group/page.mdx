...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    FSelectGroup<Sidebar>(
      controller: FMultiValueNotifier(values: {Sidebar.recents}),
...
```dart copy
FSelectGroup<Value>(
  controller: FMultiValueNotifier(), // or FMultiValueNotifier.radio()
...
<Tabs items={['Preview', 'Code']}>
    ...
    <Tabs.Tab>
        ...
        class CheckboxFormState extends State<CheckboxForm> {
          ...
          final controller = FMultiValueNotifier<Language>();
...
<Tabs items={['Preview', 'Code']}>
  ...
  <Tabs.Tab>
    ...
    class RadioFormState extends State<RadioForm> {
      final _formKey = GlobalKey<FormState>();
      final controller = FMultiValueNotifier<Notification>.radio();
