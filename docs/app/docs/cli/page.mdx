...
<Callout type="info">See the [docs](themes#customize-themes) on how to use the generated styles.</Callout>
...
<Callout type="info">See the [docs](themes#customize-themes) on how to use the generated theme.</Callout>
