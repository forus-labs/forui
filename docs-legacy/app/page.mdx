...
<Cards>
  ...
  <Cards.Card icon={<MessagesSquare />} title="Discussion" href="https://github.com/duobaseio/forui/discussions" />
  <Cards.Card icon={<FolderGit2 />} title="Source" href="https://github.com/duobaseio/forui" />
</Cards>
