...
class _AccordionControllerHook extends Hook<FAccordionController> {
  ...
  @override
  _AccordionControllerHookState createState() =>
      _AccordionControllerHookState();
...
class _AccordionControllerHookState
    extends HookState<FAccordionController, _AccordionControllerHook> {
