...
enum Style {
  ...
  fpopovermenustyle(
    ...
    <String>['FPopoverMenuStyle', 'FTileGroupStyle', 'FTileContentStyle'],
  ...
  fselectmenutilestyle(
    ...
    <String>['FSelectMenuTileStyle', 'FPopoverMenuStyle', 'FTileGroupStyle', 'FTileContentStyle'],
  ...
  ftilegroupstyle(
    ...
    <String>['FTileGroupStyle', 'FTileContentStyle'],
