...
mixin _$FThemeDataFunctions on Diagnosticable {
  ...
  FResizableStyle get resizableStyle;
  ...
  /// Returns itself.
  @useResult
  FThemeData call(Object? _) => this as FThemeData;

  @override
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    super.debugFillProperties(properties);
    properties
      ..add(StringProperty('debugLabel', debugLabel, level: DiagnosticLevel.debug))
      ..add(DiagnosticsProperty('breakpoints', breakpoints, level: DiagnosticLevel.debug))
      ..add(DiagnosticsProperty('colors', colors, level: DiagnosticLevel.debug))
