...
/// A tile that represents a selection in a [FTileSelectGroup]. It should only be used in a [FTileSelectGroup].
///
/// See:
...
class FSelectTile<T> extends StatelessWidget with FTileMixin {
  ...
  FSelectTile({
    ...
    super.key,
        ...
        // We use a transparent color instead of a sized box, to simplify changes to the checked icon size.
  ...
  Widget build(BuildContext context) {
    ...
    return FTile(
      ...
      details: details,
      suffixIcon: suffix,
      style: style, // TODO: do we need to pass in style from the parent?
