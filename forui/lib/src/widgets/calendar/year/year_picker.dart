...
class YearPicker extends StatefulWidget {
  ...
  YearPicker({
    ...
    super.key,
         ...
         startYear == startYear.truncate(to: DateUnit.years),
         'startYear must be truncated to years.',
       );
...
class _YearPickerState extends State<YearPicker> {
  ...
  void initState() {
    ...
    if (focused == null ||
        focused < widget.startYear ||
        widget.startYear.plus(years: YearPicker.items) <= focused) {
      return;
    }
  ...
  Widget build(BuildContext context) => Padding(
    ...
    child: GridView(
      ...
      children: [
        for (
          var year = widget.startYear, i = 0;
          i < YearPicker.items;
          year = year.plus(years: 1), i++
        )
          Entry.yearMonth(
