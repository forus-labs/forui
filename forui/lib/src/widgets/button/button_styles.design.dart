...
extension $FButtonStylesTransformations on FButtonStyles {
  ...
  @useResult
  FButtonStyles lerp(FButtonStyles other, double t) => .new(
...
mixin _$FButtonStylesFunctions on Diagnosticable {
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ...
      ..add(DiagnosticsProperty('secondary', secondary, level: .debug))
      ..add(DiagnosticsProperty('destructive', destructive, level: .debug))
      ..add(DiagnosticsProperty('outline', outline, level: .debug))
      ..add(DiagnosticsProperty('ghost', ghost, level: .debug));
  }
