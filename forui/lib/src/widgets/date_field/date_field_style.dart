...
class FDateFieldStyle with Diagnosticable, _$FDateFieldStyleFunctions {
  ...
  FDateFieldStyle.inherit({required FColors colors, required FTypography text, required FStyle style})
    : this(
        ...
        calendarStyle: FCalendarStyle.inherit(colors: colors, text: text, style: style),
