...
final class FPopoverMenuStyle extends FPopoverStyle with _$FPopoverMenuStyleFunctions {
  ...
  FPopoverMenuStyle.inherit({required super.colors, required super.style, required FTypography text})
    : tileGroupStyle = FTileGroupStyle.inherit(colors: colors, style: style, text: text),
      maxWidth = 250,
      super.inherit();
}
