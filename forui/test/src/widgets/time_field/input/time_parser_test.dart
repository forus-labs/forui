...
void main() {
  ...
  group('update(...)', () {
    for (final (index, (previous, current, expected)) in [
      // None - no changes
  ...
  group('updateHour(...)', () {
    for (final (i, (previous, current, expected)) in [
      // Backspace
      ('4', '', ('HH', false)),
      ('12', '', ('HH', false)),
      ('HH', '', ('HH', false)),
  ...
  group('adjustHour(...)', () {
    for (final (index, (minute, adjustment, expected)) in [
      ('11', 1, '12'),
      ('11', -1, '10'),
      //
      ('12', 1, '1'),
  ...
  for (final (index, (period, adjustment, expected)) in [
    ('--', 1, 'am'),
    ('--', 0, 'am'),
    ('--', -1, 'pm'),
    ('am', 1, 'pm'),
