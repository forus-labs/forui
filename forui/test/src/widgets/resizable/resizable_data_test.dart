...
void main() {
  group('FResizableRegionData', () {
    ...
    test(
      'percentage',
      () => expect(
        FResizableRegionData(index: 1, extent: (min: 1, max: 10, total: 100), offset: (min: 0, max: 5))
            .offsetPercentage,
        (min: 0, max: 0.05),
      ),
    );
  ...
  group('UpdatableResizableData', () {
    ...
    test(
      'update(...) beyond total',
      () => expect(
        () => FResizableRegionData(index: 0, extent: (min: 1, max: 5, total: 100), offset: (min: 0, max: 2))
            .update(4, lhs: false),
