      ...
      for (final text in ['short text', null]) {
        testWidgets('default - ${theme.name} - $focused ${text == null ? '- no text' : ''}', (tester) async {
          ...
          await tester.pumpWidget(
            TestScaffold.app(
              theme: theme.data,
              child: FTextField(
                control: .managed(controller: controller), autofocus: focused_,
                label: const Text('My Label'),
                hint: 'hint',
                description: const Text('Some help text.'),
              ),
        ...
        testWidgets('email - ${theme.name} - $focused ${text == null ? '- no text' : ''}', (tester) async {
          ...
          await tester.pumpWidget(
            TestScaffold.app(
              theme: theme.data,
              child: FTextField.email(control: .managed(controller: controller), autofocus: focused_, hint: 'janedoe@foruslabs.com'),
            ),
          );
