  ...
  group('FRating', () {
    testWidgets('renders different values', (tester) async {
      ...
      await expectLater(
        ...
        matchesGoldenFile('rating/rating_values.png'),
      );
    });
    ...
    testWidgets('renders with custom styling', (tester) async {
      ...
      await expectLater(
        find.byType(TestScaffold),
        matchesGoldenFile('rating/rating_styles.png'),
      );
    });
    ...
    testWidgets('renders with different counts', (tester) async {
      ...
      await expectLater(
        find.byType(TestScaffold),
        matchesGoldenFile('rating/rating_counts.png'),
      );
    });
    ...
    testWidgets('renders in dark theme', (tester) async {
      ...
      await expectLater(
        find.byType(TestScaffold),
        matchesGoldenFile('rating/rating_dark.png'),
      );
    });
  });
}
