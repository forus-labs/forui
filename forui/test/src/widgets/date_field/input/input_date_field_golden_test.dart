...
void main() {
  ...
  testWidgets('blue screen', (tester) async {
    await tester.pumpWidget(
      TestScaffold.blue(
        child: FDateField.input(style: TestScaffold.blueScreen.dateFieldStyle),
      ),
    );
  ...
  for (final theme in TestScaffold.themes) {
    testWidgets('${theme.name} with placeholder', (tester) async {
      await tester.pumpWidget(
        TestScaffold.app(theme: theme.data, child: FDateField.input(key: key)),
      );
      ...
      await expectLater(
        ...
        matchesGoldenFile('date-field/${theme.name}/input/placeholder.png'),
      );
    });
    ...
    testWidgets('${theme.name} with no icon', (tester) async {
      await tester.pumpWidget(
        TestScaffold(
          theme: theme.data,
          child: FDateField.input(prefixBuilder: null),
        ),
      );

      await expectLater(
        find.byType(TestScaffold),
        matchesGoldenFile('date-field/${theme.name}/input/no-icon.png'),
      );
    });
    ...
    testWidgets('${theme.name} with builder', (tester) async {
      ...
      await expectLater(
        find.byType(TestScaffold),
        matchesGoldenFile('date-field/${theme.name}/input/builder.png'),
      );
    });
    ...
    testWidgets('${theme.name} hr locale', (tester) async {
      ...
      await expectLater(
        find.byType(TestScaffold),
        matchesGoldenFile('date-field/${theme.name}/input/hr-locale.png'),
      );
    });
    ...
    testWidgets('${theme.name} disabled', (tester) async {
      ...
      await expectLater(
        find.byType(TestScaffold),
        matchesGoldenFile('date-field/${theme.name}/input/disabled.png'),
      );
    });
    ...
    testWidgets('${theme.name} error', (tester) async {
      ...
      await expectLater(
        find.byType(TestScaffold),
        matchesGoldenFile('date-field/${theme.name}/input/error.png'),
      );
    });
    ...
    testWidgets('${theme.name} unsupported locale defaults to en_US', (
      ...
      await expectLater(
        find.byType(TestScaffold),
        matchesGoldenFile(
          'date-field/${theme.name}/input/unsupported-locale.png',
        ),
      );
    });
    ...
    testWidgets('${theme.name} tap outside unfocuses on desktop', (
      ...
      await expectLater(
        find.byType(TestScaffold),
        matchesGoldenFile(
          'date-field/${theme.name}/input/desktop-unfocused.png',
        ),
      );
