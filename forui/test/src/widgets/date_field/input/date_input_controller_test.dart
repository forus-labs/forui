...
void main() {
  ...
  for (final (index, (localizations, initial, expected))
      in [
  ...
  group('value', () {
    for (final (index, (old, value, expected, date))
        in [
          // Select everything
          (
  ...
  for (final (index, (value, adjustment, expectedText, expectedDate))
      in [
        (
          const TextEditingValue(
            text: '01. 02. 2024.',
  ...
  for (final (index, (initial, value, expected))
      in [
        (
          null,
          DateTime.utc(2025, 2),
          const TextEditingValue(text: '01/02/2025'),
        ),
        (
          DateTime.utc(2025, 2),
          null,
          const TextEditingValue(text: 'DD/MM/YYYY'),
        ),
      ].indexed) {
